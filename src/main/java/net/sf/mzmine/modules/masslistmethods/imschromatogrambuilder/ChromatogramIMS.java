 ...
 */
public class ChromatogramIMS implements Feature {
   ...
   */
  public ChromatogramIMS(RawDataFile dataFile, int scanNumbers[]) {
  ...
  public void addDataPointsFromChromatogram(ChromatogramIMS ch) {
