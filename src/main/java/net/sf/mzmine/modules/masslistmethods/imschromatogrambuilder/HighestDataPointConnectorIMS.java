...
public class HighestDataPointConnectorIMS {
  ...
  private Set<ChromatogramIMS> buildingChromatograms;
  ...
  public HighestDataPointConnectorIMS(RawDataFile dataFile, int allScanNumbers[],
    ...
    buildingChromatograms = new LinkedHashSet<ChromatogramIMS>();
  ...
  public void addScan(int scanNumber, DataPoint mzValues[]) {
    ...
    Set<ChromatogramIMS> connectedChromatograms = new LinkedHashSet<ChromatogramIMS>();
    ...
    for (DataPoint mzPeak : mzValues) {
      ...
      ChromatogramIMS bestChromatogram = null;

      for (ChromatogramIMS testChrom : buildingChromatograms) {
      ...
      if (bestChromatogram != null) {
        ...
        bestChromatogram = new ChromatogramIMS(dataFile, allScanNumbers);
      }
  ...
  public ChromatogramIMS[] finishChromatograms() {
    ...
    Iterator<ChromatogramIMS> chromIterator = buildingChromatograms.iterator();
    while (chromIterator.hasNext()) {

      ChromatogramIMS chromatogram = chromIterator.next();
    ...
    ChromatogramIMS[] chromatograms = buildingChromatograms.toArray(new ChromatogramIMS[0]);
