...
public enum CommonColumnType {
  ...
  AVERAGEMOBILITY("Mobility", Double.class), //
  AVERAGECCS("CCS", Double.class), //
  IDENTITY("Identity", MobilogramIdentity.class), //
  COMMENT("Comment", String.class), //
  PEAKSHAPE("Mobilogram shape", MobilogramListRow.class);
