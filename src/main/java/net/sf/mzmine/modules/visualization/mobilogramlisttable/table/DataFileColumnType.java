...
public enum DataFileColumnType {
  ...
  STATUS("Status", IMSFeatureStatus.class), PEAKSHAPE("Peak shape", IMSFeature.class), MZ("m/z",
      Double.class), RT("RT", Double.class), MOBILITY("Mobility",
          Double.class), CCS("CCS", Double.class), RT_START("RT start",
              Double.class), RT_END("RT end", Double.class), DURATION("Duration",
                  Double.class), HEIGHT("Height", Double.class), AREA("Area",
                      Double.class), CHARGE("Charge", Integer.class), DATAPOINTS("# Data points",
