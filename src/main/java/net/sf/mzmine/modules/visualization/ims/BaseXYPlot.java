...
public class BaseXYPlot extends XYPlot {
  ...
  public ImsDataSet dataset;

  public ImsPaletteType paletteType = ImsPaletteType.PALETTE_RAINBOW;
  ...
  BaseXYPlot(ImsDataSet dataset, Range<Double> rtRange, Range<Double> mzRange,
  ...
  void switchPalette() {
    ImsPaletteType types[] = ImsPaletteType.values();
