 ...
 * 
 */
class ImsPlot extends EChartPanel {
  ...
  ImsPlot(RawDataFile rawDataFile, ImsVisualizerWindow visualizer, ImsDataSet dataset,
    ...
    if (whichPlotTypeStr == "default") {
      plot = new ImsXYPlot(dataset, rtRange, mzRange, xAxis, yAxis);
    } else if (whichPlotTypeStr == "point2D") {
      plot = new PointImsXYPlot(dataset, rtRange, mzRange, xAxis, yAxis);
    }
