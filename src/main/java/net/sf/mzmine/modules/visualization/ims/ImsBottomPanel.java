 ...
 */
class ImsBottomPanel extends JPanel implements TreeModelListener, ActionListener {
  ...
  private ImsVisualizerWindow masterFrame;
  private RawDataFile dataFile;

  ImsBottomPanel(ImsVisualizerWindow masterFrame, RawDataFile dataFile, ParameterSet parameters) {
    ...
    thresholdSettings = parameters.getParameter(ImsVisualizerParameters.peakThresholdSettings);
