...
import net.sf.mzmine.modules.visualization.mobilogramlisttable.table.MobilogramListTableModel;
import net.sf.mzmine.parameters.ParameterSet;
import net.sf.mzmine.parameters.parametertypes.WindowSettingsParameter;
import net.sf.mzmine.util.ExitCode;

public class MobilogramListTableWindow extends JFrame implements ActionListener {
  ...
  private MobilogramListTable table;
   ...
   */
  MobilogramListTableWindow(MobilogramList mobilogramList, ParameterSet parameters) {

    super("Mobilogram list: " + mobilogramList.getName());
    ...
    // Build tool bar
    MobilogramListTableToolBar toolBar = new MobilogramListTableToolBar(this);
    add(toolBar, BorderLayout.EAST);

    // Build table
    table = new MobilogramListTable(this, parameters, mobilogramList);
    ...
    ParameterSet paramSet =
        MZmineCore.getConfiguration().getModuleParameters(MobilogramListTableModule.class);
    WindowSettingsParameter settings =
        paramSet.getParameter(MobilogramListTableParameters.windowSettings);
  ...
  public void updateFilter() {
    ...
    TableRowSorter<MobilogramListTableModel> sorter =
        (TableRowSorter<MobilogramListTableModel>) table.getRowSorter();
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    if (command.equals("PROPERTIES")) {
      ...
      if (exitCode == ExitCode.OK) {
        ...
        MobilogramListTableColumnModel cm = (MobilogramListTableColumnModel) table.getColumnModel();
        cm.createColumns();
    ...
    if (command.equals("AUTOCOLUMNWIDTH")) {
      ...
      for (int column = 0; column < table.getColumnCount(); column++) {
        ...
        if (tableColumn.getHeaderValue() != "Mobilogram shape"
