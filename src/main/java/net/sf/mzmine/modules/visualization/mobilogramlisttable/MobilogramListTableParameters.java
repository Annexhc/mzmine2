...
public class MobilogramListTableParameters extends SimpleParameterSet {
  ...
  public static final ComboParameter<MobilogramShapeNormalization> mobilogramShapeNormalization =
      new ComboParameter<MobilogramShapeNormalization>("Mobilogram shape normalization",
          "Mobilogram shape normalization", MobilogramShapeNormalization.values());
  ...
  public MobilogramListTableParameters() {
    super(new Parameter[] {commonColumns, dataFileColumns, rowHeight, mobilogramShapeNormalization,
        windowSettings});
