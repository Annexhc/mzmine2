...
public class NormalizationMZSetupDialog extends ParameterSetupDialogWithScanPreview
  ...
  protected void loadPreview(SpectraPlot spectrumPlot, Scan previewScan) {
    ...
    DataPoint[] oldDPs = previewScan.getDataPoints();
    DataPoint[] newDPs = new DataPoint[previewScan.getNumberOfDataPoints()];
    ...
    ScanDataSet spectraDataSet = new ScanDataSet("Normalized scan", newScan);
