...
public class GPLipidIdentity2Chains extends SimplePeakIdentity {

    private final double mass;

    public GPLipidIdentity2Chains(final GPLipidType lipidType,
    ...
    private GPLipidIdentity2Chains(final String name, final String formula) {
	...
	return new GPLipidIdentity2Chains(getName(),
