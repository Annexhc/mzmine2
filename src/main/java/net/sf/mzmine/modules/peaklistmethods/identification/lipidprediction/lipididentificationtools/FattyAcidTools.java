...
public class FattyAcidTools {
    ...
    public ArrayList<String> calculateFattyAcidFormulas(
            int minfattyAcidLength,
            int maxfattyAcidLength,
            int maxNumberOfDoubleBonds,
            int maxOxidationValue) {
    ...
    public ArrayList<String> getFattyAcidNames(
            int minfattyAcidLength,
            int maxfattyAcidLength,
            int maxNumberOfDoubleBonds,
            int maxOxidationValue) {
    ...
    public String calculateFattyAcidFormula(int fattyAcidLength, int fattyAcidDoubleBonds, int oxidationValue) {
    ...
    public String getFattyAcidName(int fattyAcidLength, int fattyAcidDoubleBonds, int oxidationValue) {
