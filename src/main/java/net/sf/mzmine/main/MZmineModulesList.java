...
import net.sf.mzmine.modules.masslistmethods.imschromatogrambuilder.ChromatogramBuilderModuleIMS;
...
import net.sf.mzmine.modules.visualization.ims.ImsVisualizerModule;
...
public class MZmineModulesList {
  ...
  public static final Class<?> MODULES[] = new Class<?>[] {
      ...
      ChromatogramBuilderModuleIMS.class, ADAPChromatogramBuilderModule.class,
      ...
      VanKrevelenDiagramModule.class, ImsVisualizerModule.class,
