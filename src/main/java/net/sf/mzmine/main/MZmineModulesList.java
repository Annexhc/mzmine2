...
import net.sf.mzmine.modules.visualization.massremainderanalysis.MassRemainderAnalysisModule;
...
public class MZmineModulesList {
  ...
  public static final Class<?> MODULES[] = new Class<?>[] {
      ...
      MassRemainderAnalysisModule.class, VanKrevelenDiagramModule.class,
